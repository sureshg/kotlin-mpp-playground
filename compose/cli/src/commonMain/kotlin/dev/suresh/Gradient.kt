  ...
  Column {
    ...
    Text(
        buildAnnotatedString {
          ...
          append("  ")
          append("Terminal(")
          withStyle(SpanStyle(color = BrightGreen)) { append("width=") }
          withStyle(
              SpanStyle(
                  color = BrightBlue,
          ...
          append(", ")
          withStyle(SpanStyle(color = BrightGreen)) { append("height=") }
          withStyle(
              SpanStyle(
                  color = BrightBlue,
                  textStyle = TextStyle.Bold + TextStyle.Underline,
...
private fun ColumnScope.GradientsBlock() {
  val screenHalfWidth = LocalTerminal.current.size.width
  var gradientWidth by remember { mutableIntStateOf(0) }
  val gradientWidthDiff by
      remember(screenHalfWidth) { derivedStateOf { (screenHalfWidth - gradientWidth) / 5 } }
  Gradient(
      repeatedWord = "Red",
      width = gradientWidth,
